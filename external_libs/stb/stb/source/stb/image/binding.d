...
ubyte* stbi_load_from_memory(const scope void* buffer, int len, int* x, int* y, int* channels_in_file, int desired_channels);
...
ubyte* stbi_load_gif_from_memory(const scope void* buffer, int len, int** delays, int* x, int* y, int* z, int* comp, int req_comp);
...
ushort* stbi_load_16_from_memory(const scope void* buffer, int len, int* x, int* y, int* channels_in_file, int desired_channels);
...
float* stbi_loadf_from_memory(const scope void* buffer, int len, int* x, int* y, int* channels_in_file, int desired_channels);
...
int stbi_is_hdr_from_memory(const scope void* buffer, int len);
...
int stbi_info_from_memory(const scope void* buffer, int len, int* x, int* y, int* comp);
int stbi_info_from_callbacks(const(stbi_io_callbacks)* clbk, void* user, int* x, int* y, int* comp);
int stbi_is_16_bit_from_memory(const scope void* buffer, int len);
